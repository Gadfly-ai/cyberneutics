  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
      <div className="mb-3 border-b border-slate-200 pb-2">
        <h2 className="text-base font-semibold text-slate-900">ADVERSARIAL COMMITTEE</h2>
      ...
      <div
        className={`mb-3 rounded-md border border-slate-200 bg-slate-50 p-2 text-slate-700 ${
